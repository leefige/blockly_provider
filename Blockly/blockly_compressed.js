...
goog.DEPENDENCIES_ENABLED && (goog.dependencies_ = {
  ...
  goog.maybeProcessDeferredDep_ = function (a) {
    ...
    b(a);
    for (var f = 0; f < c.length; f++) a = c[f], goog.dependencies_.written[a] = !0;
  ...
  if (!goog.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT) {
    ...
    if (goog.events.CAPTURE_SIMULATION_MODE == goog.events.CaptureSimulationMode.ON) {
      if (!goog.events.isMarkedIeEvent_(d)) {
        ...
        for (var g = a.type, h = d.length - 1; !e.propagationStopped_ && 0 <= h; h--) e.currentTarget = d[h], c =
...
goog.dom.getElementsByTagNameAndClass_ = function (a, b, c, d) {
  ...
  if (c) {
    a = {};
    for (f = b = 0; g = d[f]; f++) e = g.className, "function" == typeof e.split && goog.array.contains(e.split(/\s+/), c) && (a[b++] =
      g);
    a.length = b;
    return a
  }
      ...
      try {
        if (goog.isDef(a))
          ...
          if (e[k]) c.push("*** reference loop detected (id=" + k + ") ***");
            ...
            c.push("{");
            for (var n in a)
              if (b || !goog.isFunction(a[n])) c.push("\n"), c.push(h), c.push(n +
                " = "), f(a[n], h);
            c.push("\n" + g + "}");
            delete e[k]
          }
...
goog.structs.Trie.prototype.remove = function (a) {
  ...
  for (delete c.value_; 0 < d.length;)
    if (b = d.pop(), c = b[0], b = b[1], c.childNodes_[b].isEmpty()) delete c.childNodes_[b];
    else break;
  return a
};
...
Blockly.VariableMap.prototype.renameVariable = function (a, b) {
  ...
  a && (d = g.indexOf(a));
  c && (e = g.indexOf(c)); - 1 == d && -1 == e ? (this.createVariable(b, ""), console.log("Tried to rename an non-existent variable.")) : d == e || -1 != d && -1 == e ? (c = this.variableMap_[f][d], Blockly.Events.fire(new Blockly.Events.VarRename(c, b)), c.name = b) : -1 != d && -1 != e && (c = this.variableMap_[f][e], Blockly.Events.fire(new Blockly.Events.VarRename(c, b)),
...
Blockly.Workspace.prototype.renameVariableInternal_ = function (a, b) {
  ...
  for (var c = this.getAllBlocks(), e = 0; e < c.length; e++) c[e].renameVar(a.name, b), d && c[e].renameVar(d, b);
...
Blockly.Extensions.checkDropdownOptionsInTable_ = function (a, b, c) {
  ...
  if (!d.isOptionListDynamic())
    for (var d = d.getOptions(), e = 0; e < d.length; ++e) {
      var f = d[e][1];
...
Blockly.Options = function (a) {
  ...
  if (g) {
    var h = null;
    var k = b = c = d = e = f = !1
  } else h = Blockly.Options.parseToolboxTree(a.toolbox), f = !(!h || !h.getElementsByTagName("category").length), e = a.trashcan, void 0 === e && (e = f), d = a.collapse, void 0 === d && (d = f), c = a.comments, void 0 === c && (c = f), b = a.disable, void 0 === b && (b = f), k = a.sounds, void 0 === k && (k = !0);
  var l = !!a.rtl,
...
Blockly.Xml.blockToDom = function (a, b) {
  ...
  if (e = a.getCommentText()) e = goog.dom.createDom("comment", null, e), "object" == typeof a.comment && (e.setAttribute("pinned", a.comment.isVisible()), f = a.comment.getBubbleSize(), e.setAttribute("h", f.height), e.setAttribute("w", f.width)), d.appendChild(e);
  a.data && (e = goog.dom.createDom("data", null, a.data), d.appendChild(e));
  for (e = 0; f = a.inputList[e]; e++) h = !0, f.type != Blockly.DUMMY_INPUT && (k = f.connection.targetBlock(), f.type ==
  ...
  if (e = a.getNextBlock()) c = goog.dom.createDom("next", null, Blockly.Xml.blockToDom(e, b)), d.appendChild(c);
  ...
  try {
    for (var h = 0; h < e; h++) {
      ...
      if ("block" == l || "shadow" == l && !Blockly.Events.recordUndo) {
        ...
        g = !1
      } else if ("shadow" == l) goog.asserts.fail("Shadow block cannot be a top-level block."), g = !1;
      else if ("variables" == l) {
...
Blockly.Xml.domToBlockHeadless_ = function (a, b) {
  ...
  for (var e = a.getAttribute("id"), c = b.newBlock(d, e), f = null, g = 0, h; h = a.childNodes[g]; g++)
    if (3 != h.nodeType) {
      for (var k = null, l = null, f = 0, m; m = h.childNodes[f]; f++) 1 == m.nodeType && ("block" == m.nodeName.toLowerCase() ? k = m : "shadow" == m.nodeName.toLowerCase() && (l = m));
      !k && l && (k = l);
      f = h.getAttribute("name");
      switch (h.nodeName.toLowerCase()) {
        case "mutation":
          c.domToMutation && (c.domToMutation(h),
            c.initSvg && c.initSvg());
          break;
        case "comment":
        ...
        case "statement":
          h = c.getInput(f);
          if (!h) {
            console.warn("Ignoring non-existent input " + f + " in block " +
              d);
            break
          }
  ...
  if (this.rendered && !(a.getElementsByTagName("block").length >= this.remainingCapacity())) {
    ...
    try {
      ...
      if (goog.userAgent.IE || goog.userAgent.EDGE)
        for (var c = b.getDescendants(), d = c.length - 1; 0 <= d; d--) c[d].render(!1);
      ...
      if (!isNaN(e) && !isNaN(f)) {
        ...
        do {
          var g = !1;
          for (var h =
              this.getAllBlocks(), d = 0, k; k = h[d]; d++) {
          ...
          if (!g)
            for (var m = b.getConnections_(!1), d = 0, n; n = m[d]; d++)
...
Blockly.Mutator.prototype.createEditor_ = function () {
  ...
  if (this.quarkNames_.length) {
    ...
    for (var b = 0, c; c = this.quarkNames_[b]; b++) a.appendChild(goog.dom.createDom("block", {
      type: c
    }))
  } else a = null;
  a = {
...
Blockly.Block.prototype.setConnectionsHidden = function (a) {
  var b;
  if (!a && this.isCollapsed()) this.outputConnection && this.outputConnection.setHidden(a), this.previousConnection && this.previousConnection.setHidden(a), this.nextConnection && (this.nextConnection.setHidden(a), (b = this.nextConnection.targetBlock()) && b.setConnectionsHidden(a));
  else
...
Blockly.Block.prototype.interpolate_ = function (a, b, c) {
  ...
  if (f != b.length) throw Error('Block "' + this.type + '": Message does not reference all ' + b.length +
    " arg(s).");
  ...
  for (g = 0; g < a.length; g++)
    if (f = a[g], "string" == typeof f) b.push([f, void 0]);
    else {
      d = h = null;
      do
...
Blockly.BlockSvg.prototype.renderCompute_ = function (a) {
  ...
  for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, l = this.getInputsInline() && !this.isCollapsed(), m = 0, n; n = b[m]; m++)
    if (n.isVisible()) {
      ...
      else k = n.type, p = [], p.type = l &&
        n.type != Blockly.NEXT_STATEMENT ? Blockly.BlockSvg.INLINE : n.type, p.height = 0, c.push(p);
      p.push(n);
      ...
      for (var q = !1, t = 0, r; r = n.fieldRow[t]; t++) {
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function (a, b, c, d, e, f) {
  for (var g, h, k, l, m = 0, n, p = 0, q; q = e[p]; p++) {
    ...
    if (this.isCollapsed()) l = q[0], k = h, h = m, this.renderFields_(l.fieldRow, k, h), a.push(Blockly.BlockSvg.JAGGED_TEETH), b.push("h 8"), l = q.height - Blockly.BlockSvg.JAGGED_TEETH_HEIGHT, a.push("v", l), this.RTL && (b.push("v 3.9 l 7.2,3.4 m -14.5,8.9 l 7.3,3.5"), b.push("v", l - .7)), this.width += Blockly.BlockSvg.JAGGED_TEETH_WIDTH;
...
Blockly.FieldDropdown.prototype.render_ = function () {
  if (this.visible_) {
    ...
    } else a = document.createTextNode(this.getDisplayText_()), this.textElement_.appendChild(a),
      this.sourceBlock_.RTL ? this.textElement_.insertBefore(this.arrow_, this.textElement_.firstChild) : this.textElement_.appendChild(this.arrow_), this.textElement_.setAttribute("text-anchor", "start"), this.textElement_.setAttribute("x", 0), this.size_.height = Blockly.BlockSvg.MIN_BLOCK_Y, this.size_.width = Blockly.Field.getCachedWidth(this.textElement_);
...
Blockly.FlyoutButton.prototype.createDom = function () {
  ...
  c.setAttribute("y", this.height -
    Blockly.FlyoutButton.MARGIN);
...
Blockly.bindEventWithChecks_ = function (a, b, c, d, e) {
  ...
  if (b in Blockly.Touch.TOUCH_MAP)
    for (var k = function (a) {
        g(a);
        f && a.preventDefault()
      }, l = 0, m; m = Blockly.Touch.TOUCH_MAP[b][l]; l++) a.addEventListener(m, k, !1), h.push([a, m, k]);
  return h
};
